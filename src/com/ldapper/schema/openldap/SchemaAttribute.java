package com.ldapper.schema.openldap;
	...
	public String toSchemaString() {
		...
		if (pattern != null) {
			buffer.append("ldapSyntaxes: ( ").append(syntax).append(' ').append(CR)
					...
					.append(CR).append(" )").append(CR).append(CR);
		...
		buffer.append("attributetype ( ").append(oid).append(' ').append(CR);
		...
		if (singleValue) {
			buffer.append(TAB).append("SINGLE-VALUE ").append(' ').append(CR);
		}

		if (operational) {
			buffer.append(TAB).append("NO-USER-MODIFICATION").append(' ').append(CR);
			buffer.append(TAB).append("USAGE directoryOperation").append(' ')
					.append(CR);
		}

		buffer.append(TAB).append("X-ORIGIN 'ITALTEL S.p.A'").append(CR);

		buffer.append(" )").append(CR).append(CR);
